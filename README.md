...
```bash
npm install --save-dev @zitterorg/repudiandae-blanditiis
```
...
```scss
@use 'pkg:@zitterorg/repudiandae-blanditiis' as *;
```
...
@use '../node_modules/@zitterorg/repudiandae-blanditiis' as *;
```
...
@import '../node_modules/@zitterorg/repudiandae-blanditiis/sass/true';
```
...
for more details.
See [CHANGELOG.md](https://github.com/zitterorg/repudiandae-blanditiis/blob/main/CHANGELOG.md)
...
4. Write a shim JS test file in `test/sass.test.js`:
   ...
   const sassTrue = require('@zitterorg/repudiandae-blanditiis');
